...
const Update = ({ busHouses, stations, onUpdate }) => {
    // console.log(123);
  const {
    handleSubmit,
    register,
...
//   console.log(id);
  ...
  return (
    <section className="ml-[50px] w-[70%] bg-white flex mt-3 flex-col">
      <span className="text-center text-[2vw] font-semibold ">
        Them moi chuyen xe
      </span>
      <div className="w-[100%]">
        <form className="w-[100%] mt-8" onSubmit={handleSubmit(handle_submit)}>
          ...
          <button
            type="submit"
            className="w-[30%] py-2 px-3 bg-gray-900 hover:bg-gray-500 duration-300 rounded-lg text-white mt-4"
          >
            Update
          </button>
        </form>
